...
var _responseParserTs = /*#__PURE__*/ _interopRequireDefault(
  require("./ResponseParser.js"),
);
...
var MultipartPart = /*#__PURE__*/ (function () {
  ...
  _proto.push = function push(line) {
    ...
    if (line === null) {
      if (this._parsingState.status !== ParseStatus.Response)
    ...
    if (this._parsingState.status === ParseStatus.Headers) {
      if (!line.length) {
        ...
        this._response = new _responseParserTs.default(
  ...
  _createClass(MultipartPart, [
    {
      ...
      get: function get() {
        if (this._parsingState)
          throw new Error("Attempting to use an incomplete part");
