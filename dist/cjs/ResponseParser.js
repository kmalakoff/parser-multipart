...
var _parseHeaderTs = /*#__PURE__*/ _interopRequireDefault(
  require("./lib/parseHeader.js"),
);
var _parseStatusTs = /*#__PURE__*/ _interopRequireDefault(
  require("./lib/parseStatus.js"),
);
var _parseTextTs = /*#__PURE__*/ _interopRequireDefault(
  require("./lib/parseText.js"),
);
var _responseParsedTs = /*#__PURE__*/ _interopRequireDefault(
  require("./ResponseParsed.js"),
);
var _bodyHeadersTs = /*#__PURE__*/ _interopRequireDefault(
  require("./lib/BodyHeaders.js"),
);
...
var MultipartResponse = /*#__PURE__*/ (function () {
  ...
  _proto.push = function push(line) {
    ...
    if (line === null) {
      if (this._parsingState.status !== ParseStatus.Body)
    ...
    if (this._parsingState.status === ParseStatus.Headers) {
      ...
      else if (!(0, _parseStatusTs.default)(this.headers, line))
        (0, _parseHeaderTs.default)(this.headers.headers, line, ":");
